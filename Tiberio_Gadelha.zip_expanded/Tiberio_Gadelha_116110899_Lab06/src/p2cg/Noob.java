...
public class Noob extends Usuario{
	...
	/**
	 * O usuário compra um jogo com 10% de desconto, mas antes é verificado se o mesmo possui saldo para a compra. Se tiver, o jogo é adicionado
	 * à biblioteca, ganha x2p e retorna true, se não, retorna false.
	 * @author Tibério
	 */
