...
public class Luta extends Jogo{
	...
	/**
	 * Registra a jogada de um jogo de tipo Luta. Primeiro é validado se o score é válido, depois verifica se o usuário zerou.
	 * Se o score for maior que o record, o usuário ganha o score/1000 de x2p. Se não, recebe 0 x2p.
	 * @author Tibério
	 */
