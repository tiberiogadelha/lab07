...
public abstract class Jogo {
	...
	/**
	 * O construtor de Jogo com todas as informa��es de um jogo.
	 * @param nomeJogo Nome do jogo
	 * @param preco Pre�o do jogo
	 * @author Tib�rio
	 */
	...
	/**
	 * Registra a jogada do usu�rio em um jogo e retorna a quantidade de x2p obtida, de acordo com o tipo de jogo.
	 * @param score Score obtido
	 * @param zerou Pergunta se o usu�rio zerou.
	 * @return
	 * @throws Exception
	 * @author Tib�rio
	 */
