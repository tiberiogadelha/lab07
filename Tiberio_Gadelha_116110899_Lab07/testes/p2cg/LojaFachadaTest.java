...
public class LojaFachadaTest {
	...
	public void testProcuraUsuario() throws Exception {
		...
		Usuario user = new Veterano("Tib�rio", "tiberio.gadelha");
		loja.criaUsuario("Tib�rio", "tiberio.gadelha", "Veterano");
	...
	public void testUpgradeUsuario() throws Exception {
		loja.criaUsuario("Tib�rio", "tiberio.gadelha", "noob");
